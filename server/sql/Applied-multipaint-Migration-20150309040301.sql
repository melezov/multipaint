...
--REMOVE: MultiPaint-RegisterArtist-AuthToken
Property AuthToken will be removed from object RegisterArtist in schema MultiPaint
...
ALTER TABLE "MultiPaint"."RegisterArtist" DROP COLUMN IF EXISTS "AuthToken";
